...
def write_cli_style_report(
    *,
    ...
    # ── Visual comparison table (benchmark mode: all pages with snapshots) ───
    visual_rows = _as_list(result_json.get("visual_validation"))
    visual_comparison_table = ""
    if visual_rows and mode == "benchmark":
        vc_rows_html = []
        for v in visual_rows:
            ...
            op_label = {"matched": "MATCH", "deleted": "DELETED", "inserted": "INSERTED"}.get(op, op.upper())
            vc_rows_html.append(
                f"""<tr>
                  <td>{_esc(str(pg))}</td>
        ...
        legend = (
            ...
            "Snapshot color codes: "
            "<span style='color:#f87171;'>&#9632;</span> Red = removed text &nbsp;"
            "<span style='color:#4ade80;'>&#9632;</span> Green = added text &nbsp;"
            "<span style='color:#fb923c;'>&#9632;</span> Orange = bold changed &nbsp;"
            "<span style='color:#facc15;'>&#9632;</span> Yellow = font size changed &nbsp;"
            "<span style='color:#60a5fa;'>&#9632;</span> Blue = alignment shifted"
            "</div>"
        )
    ...
    <div class="card">
      <div class="section-title">
        ...
        <div class="muted">Three-panel snapshots generated by the pixel-level diff engine.</div>
      </div>
      {legend}
      {_render_table(
          ["Page", "Alignment", "Similarity", "Text Changes", "Note", "Snapshot"],
          "".join(vc_rows_html) or "<tr><td colspan='6' class='muted'>No visual comparison data.</td></tr>"
      )}
    </div>
    """
